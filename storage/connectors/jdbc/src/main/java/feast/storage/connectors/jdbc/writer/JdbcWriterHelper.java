...
public class JdbcWriterHelper extends DoFn<FeatureRowProto.FeatureRow, String> {
  ...
  private static final Logger log = org.slf4j.LoggerFactory.getLogger(JdbcWriterHelper.class);
  ...
  public void processElement(
    ...
    System.out.println(
        String.format(
            "WriteFeatureRowToJdbcIO-%s", jdbcTemplater.getFeatureRowInsertSql(tableName)));
              ...
              public void setParameters(
                ...
                try {
                  ...
                  preparedStatement.setString(
                      3, "jdbcsnowflakefeaturesinktest0shouldwritetosnowflake");
                } catch (SQLException e) {
                  // TODO Auto-generated catch block
                  e.printStackTrace();
                }

                //    	            	  jdbcTemplater.setSinkParameters(element,preparedStatement,
                // jobName);

  ...
  public static class Store {
    ...
    public StoreProto.Store toProto()
      ...
      switch (StoreProto.Store.StoreType.valueOf(type)) {
        ...
        case Snowflake:
          StoreProto.Store.SnowflakeConfig.Builder snowflakeConfig =
              StoreProto.Store.SnowflakeConfig.newBuilder();
          JsonFormat.parser().merge(jsonWriter.writeValueAsString(config), snowflakeConfig);
          return storeProtoBuilder.setJdbcConfig(snowflakeConfig.build()).build();
        default:
